...
function onUpload(event: any) {
    ...
    fr.onload = () => {
        ...
        uploadedImg.value = URL.createObjectURL(fileBlob);
    ...
    <form @submit.prevent="onSubmit">
        <div class="flex justify-content-center p-fluid user-profile">
            <div v-focustrap class="card">
                <div class="field">
                    <Image v-if="!uploadedImg" :src="user.photo ? user.photo : '/def-usr-image.jpg'" alt="Image"
                        width="250" height="250" />
                    <Image v-if="uploadedImg" :src="uploadedImg" alt="Image"
                        width="250" height="250" />
